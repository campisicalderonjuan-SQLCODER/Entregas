-- ============================================================================
-- SCRIPT DE CREACIÓN Y CARGA DE DATOS - TECHSTORE
...
-- Eliminación de tablas en orden inverso a las dependencias (FK)
-- ============================================================================
...
-- Creación de tablas respetando el orden lógico de dependencias
-- ============================================================================

-- 1. Tabla categorias (Dimensión)
...
-- Carga de los 25 registros requeridos
-- ============================================================================
